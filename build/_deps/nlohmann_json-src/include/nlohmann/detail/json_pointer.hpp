...
template <typename RefStringType> class json_pointer {
  ...
  public:
    ...
    string_t to_string() const
    {
        return std::accumulate(reference_tokens.begin(), reference_tokens.end(),
            string_t {}, [](const string_t& a, const string_t& b) {
    ...
    static typename BasicJsonType::size_type array_index(const string_t& s)
    {
                ...
                != s.size())) // incomplete read
        {
            JSON_THROW(detail::out_of_range::create(404,
                detail::concat("unresolved reference token '", s, "'"),
                nullptr));
        }
  ...
  public:
    ...
    friend bool operator==(
        const json_pointer<RefStringTypeLhs>& lhs, const StringType& rhs);
    ...
    // NOLINTNEXTLINE(readability-redundant-declaration)
    friend bool operator==(
        const StringType& lhs, const json_pointer<RefStringTypeRhs>& rhs);
